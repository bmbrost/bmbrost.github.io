...
<!-- https://github.com/jmgirard/affcomlab/blob/main/_extensions/jmgirard/embedpdf/embedpdf.lua -->
<!-- https://silviacanelon.com/publication/-->
<!-- https://github.com/spcanelon/silvia/blob/main/publication/_metadata.yml -->
...
.year-title { margin: 0; font-size: 1.05rem; font-weight:400; font-color: #002642; border-bottom: 1px solid #e5e7eb; padding-bottom: 2px; }
...
.pub-title { font-family: Petrona; font-color: #002642; font-weight: 600; font-size: 1.05rem; margin-bottom: 4px; }
...
build_card <- function(
  ...
  ttl_node <- if (isTRUE(nzchar(doi_url %||% ""))) {
    tags$div(class = "pub-title", title)  # plain title, no hyperlink
    # tags$div(class = "pub-title", tags$a(title, href = doi_url, target = "_blank", rel = "noopener"))  # add hyperlink to title
  } else {
  ...
  actions <- tags$div(
    ...
    if (isTRUE(nzchar(doi_url %||% "")))  # add URL to bottom of card
      tags$a("URL",class="external",href=doi_url,target="_blank",rel="noopener"),
    if (isTRUE(has_preprint_key))
      tags$a("PDF", class = "external", href = (preprint_url %||% "#"), target = "_blank", rel="noopener"),
