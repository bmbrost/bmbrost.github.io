...
.year-title { margin: 0; font-size: 1.05rem; font-weight:500; font-color: #002642; border-bottom: 1px solid #e5e7eb; padding-bottom: 2px; }
...
.pub-title { font-family: Patrona; font-weight: 600; font-size: 1.05rem; margin-bottom: 4px; }
...
build_card <- function(
  ...
  ttl_node <- if (isTRUE(nzchar(doi_url %||% ""))) {
    tags$div(class = "pub-title", title)  # don't add hyperlink to title
