...
ggplot() +
  ...
  coord_sf(
    xlim = c(-107.94, -107.817),
    ylim = c(37.235, 37.3375),
    expand = TRUE,
    clip = "on"
  ) +
  geom_circle(
    aes(x0 = x, y0 = y, r = 0.00275),
    data = dgo_labs,
    fill = "white",
    color = "gray20",
    linewidth = 0.3
...
ggsave("out/dgo.pdf", height = 7, width = 6)
pdf_convert("out/dgo.pdf",
            filenames = "out/dgo.png",
            format = "png",
            dpi = 600)
